...
from multi_agent_rag.components.arxiv import arxiv_search
from multi_agent_rag.components.detect_hallucination import (
    is_answer_grounded_on_context,
)
from multi_agent_rag.components.generate_response import generate_response
from multi_agent_rag.components.query_rewriter import rewrite_query
from multi_agent_rag.components.reranker import rerank_documents
from multi_agent_rag.components.retriever import retrieve
from multi_agent_rag.components.route import route_question
from multi_agent_rag.logging import logger, response_logger
...
if __name__ == "__main__":
    ...
    inputs = {"question": "What is linear regression?"}
    value = None
